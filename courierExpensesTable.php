...
<html>
	...
	<?php
		...
		$sql = "SELECT * FROM courierexpenses WHERE courierexpenses.courierID='$courierID'";
		$result = mysqli_query($combine,$sql);
		$count = mysqli_num_rows($result);
	?>
	
	<h1 style = "color:#21618C; margin-left:330px; padding-top:30px;">Courier Expenses Detail Table</h1><br/>
	<table>
		<tr>
			<th colspan = "4">
				<button class = "button"><a href = "courierExpenses.php">ADD NEW</a></button>
			</th>
		</tr>
		<tr>
