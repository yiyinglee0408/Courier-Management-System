...
<html>
	...
	<?php 
			...
			if(isset($_POST['submitted']))
			{
				...
				$query=mysqli_query($combine,"insert into parceltracking(deliveryID,parcelStatus) value('$ID',' $parcelStatus')");
		...
		<div class = "container">
			...
			?>
					...
					<?php
						if($row['parcelStatus'] != '0')
						{
							$result = mysqli_query($combine,"select parceltracking.parcelStatus as ps,parceltracking.statusDate from user_delivery_details left join parceltracking on parceltracking.deliveryID=user_delivery_details.deliveryID where user_delivery_details.deliveryID='$ID'");
							$i = 1;
					...
					?>
							<form method = "POST" name = "submitted" class = "form">
								...
								<select name = "parcelStatus">
									 ...
									 <option value="Pickup Failed" style="color: green">Pickup Failed</option>
