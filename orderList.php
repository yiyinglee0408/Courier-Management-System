...
<html>
	...
	<?php
		...
		$sql = "SELECT *FROM user_delivery_details WHERE user_delivery_details.courierID='$courierID'";
	...
	<body>
		...
		<h1 style = "color:#21618C; margin-left:330px; padding-top:30px;">Order List</h1><br/>
